          ...
          <div className="bg-white dark:bg-[#1e1f26] rounded-2xl border border-slate-200 dark:border-slate-700 max-w-xl w-full p-5 shadow-2xl space-y-4">
            <div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-700 pb-3 gap-3">
              <div className="flex items-center gap-2 min-w-0">
                <span className="material-symbols-outlined text-[#1b365d] dark:text-blue-400 text-[20px] shrink-0">
                  badge
                </span>
                <h3
                  className="font-bold text-sm text-[#1b365d] dark:text-white truncate"
