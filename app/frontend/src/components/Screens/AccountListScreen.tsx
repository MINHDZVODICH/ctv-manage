                ...
                <tr>
                  <td colSpan={5} className="py-16 text-center">
                    <div className="flex flex-col items-center justify-center gap-2">
                      <div className="w-12 h-12 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-400 flex items-center justify-center mb-1">
                        <span className="material-symbols-outlined text-[28px]">group_off</span>
                      </div>
                      <p className="text-sm font-semibold text-slate-700 dark:text-slate-300">
                        {searchTerm ? "Không tìm thấy tài khoản phù hợp" : "Chưa có tài khoản cộng tác viên nào"}
                      </p>
                      <p className="text-xs text-slate-400 max-w-sm">
                        {searchTerm
                          ? "Vui lòng thử lại với từ khóa tìm kiếm khác hoặc xóa bộ lọc."
                          : "Hệ thống đang ở trạng thái sạch. Các tài khoản mới sẽ hiển thị tại đây sau khi được phê duyệt từ hồ sơ đăng ký."}
                      </p>
                    </div>
                  </td>
                </tr>
