                  ...
                  <td colSpan={5} className="py-16 text-center">
                    <div className="flex flex-col items-center justify-center gap-2">
                      ...
                      <p className="text-sm font-semibold text-slate-700 dark:text-slate-300">
                        {searchTerm ? "Không tìm thấy hồ sơ phù hợp" : "Chưa có hồ sơ đăng ký ứng tuyển nào"}
                      </p>
                      <p className="text-xs text-slate-400 max-w-sm">
                        {searchTerm
                          ? "Vui lòng thử lại với từ khóa tìm kiếm khác hoặc xóa bộ lọc."
                          : "Khi ứng viên nộp hồ sơ đăng ký CTV trực tuyến, các yêu cầu chờ duyệt sẽ hiển thị tại đây."}
                      </p>
                    </div>
                  </td>
                </tr>
