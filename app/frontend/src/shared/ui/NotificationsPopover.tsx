      ...
      >
        <div className="p-4 border-b border-[#E2E8F0] dark:border-[#3b3d45] bg-[#F8FAFC] dark:bg-[#1f2024] flex items-center justify-between">
          <div className="flex items-center gap-2">
            <h4 className="font-bold text-sm text-[#1a1b1e] dark:text-white">
            ...
            notifications.map((n) => (
              <div
                ...
                className={`p-3.5 transition-colors flex gap-3 ${
                  !n.read
                    ? 'bg-[#d6e3ff]/10 dark:bg-blue-900/10 font-medium'
                    : 'hover:bg-[#F8FAFC] dark:hover:bg-[#2c2d33]'
                }`}
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-[#44474e] dark:text-slate-300 mt-0.5 leading-snug">
                    {n.message}
                  </p>
                  <span className="text-[10px] text-[#74777f] dark:text-[#9ca3af] mt-1 block">
                    {n.time}
                  </span>
                </div>
              </div>
