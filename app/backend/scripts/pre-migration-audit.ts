...
async function audit() {
  ...
  if (invalidRoles.length > 0) throw new Error(`Invalid Account roles: ${JSON.stringify(invalidRoles)}`);
  ...
  if (invalidAccStatus.length > 0) throw new Error(`Invalid Account status: ${JSON.stringify(invalidAccStatus)}`);
  ...
  if (invalidRegStatus.length > 0) throw new Error(`Invalid RegistrationRequest status: ${JSON.stringify(invalidRegStatus)}`);
  ...
  if (invalidFileStates.length > 0) throw new Error(`Invalid FileAsset state: ${JSON.stringify(invalidFileStates)}`);
  ...
  if (invalidReqCats.length > 0) throw new Error(`Invalid RegistrationRequestFile categories: ${JSON.stringify(invalidReqCats)}`);
  ...
  if (invalidAccCats.length > 0) throw new Error(`Invalid AccountFile categories: ${JSON.stringify(invalidAccCats)}`);
  ...
  if (invalidSchedRooms.length > 0) throw new Error(`Invalid Schedule roomCode: ${JSON.stringify(invalidSchedRooms)}`);
  ...
  if (invalidShiftPeriods.length > 0) throw new Error(`Invalid Shift periods: ${JSON.stringify(invalidShiftPeriods)}`);
  ...
  if (invalidShiftWeekdays.length > 0) throw new Error(`Invalid Shift weekdays: ${JSON.stringify(invalidShiftWeekdays)}`);
  ...
  if (invalidHistPeriods.length > 0) throw new Error(`Invalid History periods: ${JSON.stringify(invalidHistPeriods)}`);
  ...
  if (invalidHistRooms.length > 0) throw new Error(`Invalid History roomCodes: ${JSON.stringify(invalidHistRooms)}`);
  ...
  if (invalidHistStatus.length > 0) throw new Error(`Invalid History status: ${JSON.stringify(invalidHistStatus)}`);
  ...
  if (invalidSnapStatus.length > 0) throw new Error(`Invalid SnapshotRun status: ${JSON.stringify(invalidSnapStatus)}`);
  ...
  if (invalidRateScopes.length > 0) throw new Error(`Invalid RateLimitWindow scopes: ${JSON.stringify(invalidRateScopes)}`);
